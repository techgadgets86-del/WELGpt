...
import OrbModel from "@/components/ui/OrbModel";
  ...
  return (
    <div className="max-w-5xl mx-auto relative z-10 pt-4 min-h-full flex pb-[160px] md:pb-12 flex-col">
      ...
      <header className="mb-12">
        ...
        >
          The WelGPT <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-fuchsia-400">Library.</span>
        </motion.h1>
        <motion.p 
            initial={{ opacity: 0 }} 
            animate={{ opacity: 1 }} 
